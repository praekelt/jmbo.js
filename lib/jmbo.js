...
(function() {
  ...
  ControllerView = (function(_super) {
    ...
    ControllerView.prototype.push = function(newView, options) {
      var controller, currentView, defaultOptions;
      defaultOptions = {
      ...
      if (controller != null) {
        ...
        currentView.animate(options.animation, 'out', function() {
    ...
    ControllerView.prototype.pop = function(options) {
      var controller, currentView, defaultOptions, newController, newView;
      defaultOptions = {
        animation: 'slide-right'
      };
      options = _.extend(defaultOptions, options);
