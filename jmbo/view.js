...
(function() {
  var NavigationControllerView, TabBarControllerView, TitleView, ViewController, ViewControllerView, ViewControllers,
  ...
  TabBarControllerView = (function(_super) {
    ...
    TabBarControllerView.prototype.initialize = function() {
      this.collection = null;
      this.collection = new ViewControllers;
      return this.selectedIndex = 0;
    };

    TabBarControllerView.prototype.selectedIndex = function(index) {
      if (index == null) {
        index = 0;
      }
    };
